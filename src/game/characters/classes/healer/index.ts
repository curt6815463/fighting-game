...
const data = {
    ...
    skill2: { name: '神聖光環', type: 'zone', range: 0, radius: 150, dmg: 8, lifetime: 6, tick: 0.5, follow: true, allyHeal: 14, allyHealVfx: 'healer_aura_heal_tick', effect: { kind: 'burn', duration: 2, tick: 0.5, dmg: 5 }, manaCost: 40, cd: 11, color: '#55efc4', vfx: 'healer_aura', self: { effect: { kind: 'haste', duration: 6, factor: 1.2 } } },
