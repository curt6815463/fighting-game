...
const data = {
    ...
    skill1: { name: '凝滯咒', type: 'projectile', dmg: 16, speed: 600, radius: 13, lifetime: 1.1, knockback: 30, manaCost: 25, cd: 9, color: '#80deea', detonate: { perStack: 12, consume: true, stun: 0.4, slow: { duration: 3, factor: 0.5 } }, vfx: 'chronohex_bolt' },
    skill2: { name: '災厄咒', type: 'projectile', dmg: 20, speed: 640, radius: 13, lifetime: 1.1, knockback: 30, manaCost: 30, cd: 11, color: '#b07cff', detonate: { perStack: 24, consume: true, stun: 0.5 }, vfx: 'chronohex_bolt' },
