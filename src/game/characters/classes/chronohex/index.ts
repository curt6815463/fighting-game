...
const data = {
    ...
    skill1: { name: '凝滯咒', type: 'projectile', dmg: 18, speed: 600, radius: 13, lifetime: 1.1, knockback: 30, manaCost: 25, cd: 9, color: '#80deea', detonate: { perStack: 16, consume: true, stun: 0.3, stunPerStack: 0.07, slow: { duration: 2, factor: 0.6 }, slowPerStack: 0.45, slowFactorPerStack: 0.025, slowFactorMin: 0.35 }, vfx: 'chronohex_bolt' },
    skill2: { name: '災厄咒', type: 'projectile', dmg: 24, speed: 640, radius: 13, lifetime: 1.1, knockback: 30, manaCost: 30, cd: 11, color: '#b07cff', detonate: { perStack: 34, consume: true, stun: 0.3, stunPerStack: 0.09 }, vfx: 'chronohex_bolt' },
