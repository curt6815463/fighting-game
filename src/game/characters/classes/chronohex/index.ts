...
const data = {
    ...
    skill1: { name: '凝滯咒', type: 'projectile', dmg: 20, speed: 600, radius: 13, lifetime: 1.1, knockback: 30, manaCost: 25, cd: 9, color: '#80deea', detonate: { perStack: 16, consume: true, stun: 1.0, stunPerStack: 0.05, slow: { duration: 3, factor: 0.5 }, slowPerStack: 0.35, slowFactorPerStack: 0.02, slowFactorMin: 0.35 }, vfx: 'chronohex_bolt' },
    skill2: { name: '災厄咒', type: 'projectile', dmg: 28, speed: 640, radius: 13, lifetime: 1.1, knockback: 30, manaCost: 30, cd: 11, color: '#b07cff', detonate: { perStack: 34, consume: true, stun: 1.0, stunPerStack: 0.06 }, vfx: 'chronohex_bolt' },
