...
const data = {
    ...
    skill2: { name: '寒霜足跡', type: 'buff', duration: 3, manaCost: 40, cd: 9, color: '#74e0ff', vfx: 'elem_frost', effect: { kind: 'haste', duration: 3, factor: 1.6 }, trail: { duration: 3, spacing: 120, zone: { radius: 120, dmg: 8, lifetime: 5.0, tick: 0.5, effect: { kind: 'chill', stacks: 1, duration: 2, max: 4, freezeDur: 1.0, freezeVfx: 'elem_frost', freezeColor: '#9fe8ff' }, color: '#9fe8ff', vfx: 'elem_frost' } }, castZone: { radius: 120, dmg: 8, lifetime: 5.0, tick: 0.5, effect: { kind: 'chill', stacks: 1, duration: 2, max: 4, freezeDur: 1.0, freezeVfx: 'elem_frost', freezeColor: '#9fe8ff' }, color: '#9fe8ff', vfx: 'elem_frost' } },
