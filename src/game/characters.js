...
export const CHARACTERS = [
  ...
  },
  {
    ...
    basic: { name: '雙槍射擊', type: 'projectile', dmg: 11, speed: 720, radius: 9, lifetime: 1.0, count: 2, spread: 0.1, knockback: 20, cd: 0.28, color: '#f6c544', vfx: 'gunner_shot' },
  ...
  },
  {
    ...
    basic: { name: '靈魂碎片', type: 'projectile', dmg: 12, speed: 420, radius: 11, lifetime: 1.6, knockback: 30, homing: 2.5, cd: 0.6, color: '#48d8b8', vfx: 'summoner_shard' },
  ...
  },
  {
    ...
    maxHp: 230, maxMana: 110, speed: 155,
    ...
    talent: { id: 'undeath', name: '亡者之觸', desc: '你造成的持續傷害(燃燒/流血)每跳回復自身等量 40% 的生命。', factor: 0.4 },
    basic: { name: '死亡射線', type: 'projectile', dmg: 14, speed: 560, radius: 12, lifetime: 1.3, knockback: 30, cd: 0.5, color: '#6ab04c', effect: { kind: 'bleed', duration: 3, tick: 0.5, dmg: 9, moveMult: 1.0 }, vfx: 'necro_ray' },
    skill1: { name: '生命汲取', type: 'channel', duration: 3, tick: 0.4, range: 320, dmg: 26, heal: 22, manaCost: 30, cd: 8, color: '#7bed9f', vfx: 'necro_drain' },
    ...
    ultimate: { name: '亡靈大軍', type: 'summon', count: 2, cap: 4, minionCharId: 2, minionHp: 150, minionScale: 0.64, minionLife: 16, zone: { radius: 220, dmg: 20, lifetime: 5, tick: 0.5, effect: { kind: 'bleed', duration: 3, tick: 0.5, dmg: 10, moveMult: 1.0 }, color: '#1e8449', vfx: 'necro_ultimate' }, cd: 12, color: '#2ecc71', vfx: 'necro_ultimate', self: { shield: 150, duration: 6, effects: [{ kind: 'lifesteal', duration: 8, factor: 0.4 }] } },
  },
  {
